<?php namespace Anaxexp\Ultima\Template;
...
class Wrapper implements WrapperInterface
{
    ...
    {
        $wrappers = apply_filters('ultima/wrap_' . $this->slug, $this->wrapper) ?: $this->wrapper;
    ...
    {
        $template = apply_filters('ultima/unwrap_' . $this->slug, $this->template) ?: $this->template;
